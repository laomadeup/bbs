					...
					<div class="row">
					  ...
					  <div class="col-md-8">
					    <div class="input-group">
					      ...
					      <input type="text" name="title" class="form-control article_title" placeholder="文章标题" value="${article.title }">
					    </div>
					  </div>
					</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			$('.articleedit #publishArticle').click(function(){
				...
				$('.articleedit').find("input[name='content']").val(article_info);
				
				var content = $('.articleedit').find("input[name='content']").val();
				var paramter = $('#editarticle').serialize();
				console.log(paramter+"------"+paramter);
				
				$.ajax({
	    			url:'${baseUrl}/user/modifyArticleAjax.do',
	    			type:'post',
	    			async:false,
