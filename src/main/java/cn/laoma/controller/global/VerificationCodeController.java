...
import cn.laoma.utils.ResourceUtil;
...
public class VerificationCodeController{
	 ...
	 * 这里用作存入session的名称
	 */
	private static final String SESSION_KEY_OF_RAND_CODE = "randCode"; // todo
																		// 要统一常量
	...
	private String exctractRandCode() {
		final String randCodeType = ResourceUtil.getRandCodeType("/sysconfig.properties");
		int randCodeLength = Integer.parseInt(ResourceUtil.getRandCodeLength("/sysconfig.properties"));
